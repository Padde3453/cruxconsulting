...
const StatsSection = () => {
  ...
  const stats = [
    { value: "300%", label: "Average ROI Increase", delay: "0s" },
    { value: "48h", label: "Implementation Time", delay: "0.2s" },
    { value: "95%", label: "Client Satisfaction", delay: "0.4s" },
    { value: "50+", label: "SMEs Transformed", delay: "0.6s" }
  ];
